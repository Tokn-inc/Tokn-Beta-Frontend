      ...
      <style>{'body { background-color: #131313; }'}</style>
        ...
        <div className="container">
            ...
            <button type="button" name="button" class="btn-primar3y stream">
                ...
                <Link to="./BuyNowNew"> <button className="newsellnowbutton44">Buy Now</button></Link><br></br>
                <button className="presalebuttonee">Presale</button>
