        ...
        <div className="container">
            ...
            <button type="button" name="button"  class="btn-primar3y stream">
               ...
               <Link to="./NewPlaceBid"> <button className="newbidbtn">Place Bid</button></Link><br>
                ...
                <Link to="./BuyNowNew"> <button className="newsellnowbutton44">Buy Now</button></Link>
              
                <button className="soldoutbuttonplace">Soldout</button>
...
export default NewSongProfile3;
